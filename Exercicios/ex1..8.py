#Codigo para escrever uma saudação
print("Ola, mundo")

#Codigo para dar boas vindas ao usuario
nome = input("Como você se chama?")
print(f"{nome}, seja muito bem-vindo")

#Codigo para somar dois numeros
...
#Codigo para ler o dobro, triplo e a raiz de um numero
